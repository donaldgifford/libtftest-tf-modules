...
| IMPL-0002 | Managed Node Group Module Implementation | Completed | 2026-05-15 | Donald Gifford | [0002-managed-node-group-module-implementation.md](0002-managed-node-group-module-implementation.md) |
...
| IMPL-0020 | EKS hub posture workload classes endpoint fence and access entries | Draft | 2026-08-28 | Donald Gifford | [0020-eks-hub-posture-workload-classes-endpoint-fence-and-access.md](0020-eks-hub-posture-workload-classes-endpoint-fence-and-access.md) |
