...
- [Open Questions](#open-questions)
  ...
  - [Q2 — `aws_efs_file_system.lifecycle_policy` block shape — RESOLVED (a)](#q2--aws_efs_file_systemlifecycle_policy-block-shape--resolved-a)
  - [Q3 — `var.access_points` value object shape — RESOLVED (a)](#q3--varaccess_points-value-object-shape--resolved-a)
  - [Q4 — Validate access-point POSIX UID/GID bounds — RESOLVED (a)](#q4--validate-access-point-posix-uidgid-bounds--resolved-a)
  - [Q5 — EFS `file_system_policy` — RESOLVED (a)](#q5--efs-file_system_policy--resolved-a)
  - [Q6 — Module-managed KMS `prevent_destroy` — RESOLVED (a)](#q6--module-managed-kms-prevent_destroy--resolved-a)
  ...
  - [Q10 — `creation_token` collisions on destroy + re-apply — RESOLVED (a)](#q10--creation_token-collisions-on-destroy--re-apply--resolved-a)
