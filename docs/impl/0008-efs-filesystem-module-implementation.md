...
- [Implementation Phases](#implementation-phases)
  ...
  - [Phase 6: Access points (foreach over var.accesspoints)](#phase-6-access-points-foreach-over-varaccesspoints)
    - [Tasks](#tasks-5)
...
- [Open Questions](#open-questions)
  - [Q1 — VPC remote-state output field name for subnets — RESOLVED (a)](#q1--vpc-remote-state-output-field-name-for-subnets--resolved-a)
  - [Q2 — awsefsfilesystem.lifecyclepolicy block shape — RESOLVED (a)](#q2--awsefsfilesystemlifecyclepolicy-block-shape--resolved-a)
  - [Q3 — var.access_points value object shape — RESOLVED (a)](#q3--varaccesspoints-value-object-shape--resolved-a)
  - [Q4 — Validate access-point POSIX UID/GID bounds — RESOLVED (a)](#q4--validate-access-point-posix-uidgid-bounds--resolved-a)
  - [Q5 — EFS filesystempolicy — RESOLVED (a)](#q5--efs-filesystempolicy--resolved-a)
  - [Q6 — Module-managed KMS prevent_destroy — RESOLVED (a)](#q6--module-managed-kms-preventdestroy--resolved-a)
  - [Q7 — Mount target SG list — RESOLVED (a)](#q7--mount-target-sg-list--resolved-a)
  - [Q8 — tests-localstack fixture — RESOLVED (a)](#q8--tests-localstack-fixture--resolved-a)
  - [Q9 — Mount target tags API gap — RESOLVED (a)](#q9--mount-target-tags-api-gap--resolved-a)
  - [Q10 — creation_token collisions on destroy + re-apply — RESOLVED (a)](#q10--creationtoken-collisions-on-destroy--re-apply--resolved-a)
  - [Q11 — terraform test validation file shape — RESOLVED (a)](#q11--terraform-test-validation-file-shape--resolved-a)
