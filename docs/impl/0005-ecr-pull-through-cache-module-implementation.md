...
- [Open Questions](#open-questions)
  ...
  - [Q3 — `aws_ecr_repository_creation_template` schema verification](#q3--aws_ecr_repository_creation_template-schema-verification)
  - [Q4 — `cache_url_prefixes` URL construction reliability](#q4--cache_url_prefixes-url-construction-reliability)
  ...
  - [Q6 — LocalStack Pro `aws_ecr_repository_creation_template` fidelity](#q6--localstack-pro-aws_ecr_repository_creation_template-fidelity)
  - [Q7 — `node_pull_through_policy_arn` attached at Terragrunt layer or at module layer?](#q7--node_pull_through_policy_arn-attached-at-terragrunt-layer-or-at-module-layer)
