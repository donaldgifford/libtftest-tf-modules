...
| INV-0005 | Terragrunt multi-account remote-state pattern for module data lookups | Open | 2026-07-24 | Donald Gifford | [0005-terragrunt-multi-account-remote-state-pattern-for-module-data.md](0005-terragrunt-multi-account-remote-state-pattern-for-module-data.md) |
