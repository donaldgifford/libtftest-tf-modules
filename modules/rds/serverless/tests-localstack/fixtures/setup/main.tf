...
#
# The serverless module reads vpc_id + private_subnet_ids from a
...
resource "aws_vpc" "this" {
  ...
  tags = {
    Name = "tftest-rds-serverless-vpc"
  }
}
...
resource "aws_subnet" "private" {
  ...
  tags = {
    Name = "tftest-rds-serverless-private-${count.index}"
    Tier = "private"
  }
}
...
resource "aws_s3_object" "vpc_state" {
  ...
  content = jsonencode({
    ...
    serial            = 1
    lineage           = "tftest-rds-serverless-stub-vpc"
    outputs = {
      vpc_id = {
