...
resource "aws_db_subnet_group" "this" {
  ...
  description = "Aurora Serverless v2 cluster ${var.identifier_prefix} subnet group"
...
resource "aws_security_group" "this" {
  name        = "${var.identifier_prefix}-rds-serverless"
  description = "Aurora Serverless v2 cluster ${var.identifier_prefix} security group"
