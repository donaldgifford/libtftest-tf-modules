...
# modules/ecr/org-registry/kms.tf — destroying the key after the
...
resource "aws_kms_key" "this" {
  ...
  description             = "KMS key for Aurora Serverless v2 cluster ${var.identifier_prefix} (storage at rest + master user secret per IMPL-0007 Q12)"
