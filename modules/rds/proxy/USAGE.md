...
| account\_name | Terragrunt account name — the <account\_name> prefix of the account-scoped remote-state key this module reads (<account\_name>/<region>/rds/<dir>/<target\_identifier>/terraform.tfstate). | `string` | n/a | yes |
...
| remote\_state\_bucket | S3 bucket holding the target DB module's terraform state. The proxy reads <account\_name>/<region>/rds/<dir>/<target\_identifier>/terraform.tfstate for the target's outputs (DESIGN-0010 Q3 — remote-state composition; account-scoped key per IMPL-0015). | `string` | n/a | yes |
