...
terraform {
  ...
  # variable from 1.9 onward (IMPL-0023 OQ 1a — NOT DESIGN-0026's OQ 1,
  # which is how the VPC is resolved).
  #
  ...
  # (IMPL-0023 OQ 1b), which changes both its error site and its
  # message.
